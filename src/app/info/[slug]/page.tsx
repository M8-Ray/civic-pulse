...
const CONTENT_MAP: Record<string, { title: string; subtitle: string; content: string[] }> = {
  about: {
    ...
    content: [
      "CiviLog is a community-led digital mapping workspace designed to empower citizens to directly influence their urban environment.",
  ...
  privacy: {
    ...
    content: [
      "CiviLog values your privacy. Geolocation coordinates are gathered dynamically on-device and processed locally via standard web geolocation APIs.",
  ...
  terms: {
    ...
    content: [
      "By utilizing CiviLog, citizens agree to report real and accurate visual evidence of community damage.",
  ...
  cookies: {
    ...
    content: [
      "CiviLog does not utilize advertising scripts or tracking cookies.",
  ...
  contact: {
    title: "Contact Us",
    subtitle: "Get in touch with the CiviLog support crew",
    content: [
      "For administrative reviews or technical support queries, drop us a line at support@civilog.org.",
      "Phone: +1 (800) CIVI-LOG (Mon-Fri, 9:00 AM - 5:00 PM).",
  ...
  'report-content': {
    ...
    content: [
      ...
      "You can send the issue ID to flag@civilog.org for manual coordinate verification and marker pruning.",
