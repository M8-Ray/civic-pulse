...
export default function ReportPage() {
  ...
  const shareOnWhatsApp = () => {
    ...
    const message = `🚨 *CiviLog Grievance Alert* 🚨
...
Verified via CiviLog (${appUrl}). Please resolve at the earliest! #CiviLog #SmartCity`;
  ...
  const emailToMunicipality = () => {
    try {
      ...
      const subject = `🚨 [CiviLog Grievance Alert] ${submittedIssue.category} Issue: ${submittedIssue.title}`;
...
This issue has been reported and verified by local residents on the CiviLog live dashboard. 
          ...
          submittedIssue ? (
            ...
            <form onSubmit={handleSubmit} className={`${styles.formCard} glass`}>
              ...
              <div style={{
                ...
                <div>
                  <strong>CiviLog AI Autofill Active:</strong> Categorized and structured description automatically from scanning results.
                </div>
              </div>
              ...
              {emailDetails.isSupported ? (
                ...
                <>
                  ...
                  <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', lineHeight: '1.5' }}>
                    CiviLog municipal integration routes reports directly to official endpoints. However, your reported coordinates 
                  ...
                  <div style={{ marginTop: '6px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    <p style={{ fontSize: '0.75rem', color: 'var(--text-secondary)', lineHeight: '1.4' }}>
                      You can still copy the formal report draft generated by CiviLog to manually email your local authorities:
                    </p>
                    <button
                      type="button"
                      onClick={() => {
